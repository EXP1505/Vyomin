// Standard ISO 3166-1 alpha-3 country code list (name -> code), used for the actor
// autocomplete/combobox in EventStudyAnalysis.jsx. GDELT's actor country codes are near-ISO3
// (confirmed against GdeltIngestionService's own whitelist map on the backend, e.g. USA/GBR/PRK/
// TWN/RUS/UKR all match standard ISO3), so this list is what the backend's actor1CountryCode/
// actor2CountryCode filters already expect - no separate GDELT-specific code list needed.
export const COUNTRIES = [
  ...
  { name: 'Congo (Republic of)', code: 'COG' },
