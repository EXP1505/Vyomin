      ...
      <nav className="w-64 bg-slate-950 border-r border-slate-800 flex flex-col">
        ...
        <div className="flex-grow p-4 space-y-2">
          ...
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-md transition-colors ${activeTab === 'finance' ? 'bg-emerald-900/30 text-emerald-400 border border-emerald-800/50' : 'hover:bg-slate-800 text-slate-400'}`}
          >
            Financial Telemetry
          </button>
        </div>
